...
```
Based on the QQplot above, we can see that the observations mostly follow the red line with no dramatic outliers, indicating linearity and that normality has been met.
